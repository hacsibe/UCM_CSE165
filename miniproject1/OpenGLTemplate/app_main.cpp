...
void appDrawScene() {
    ...
    // Draw stuff here
    //Letter H
	glColor3f(1.0,0.0,0.0);     //this part creates first line
	glBegin(GL_POLYGON);
	...
	glColor3f(1.0,0.0,0.0);   //this creates the rectangle in the middle
	glBegin(GL_POLYGON);
	...
	glColor3f(1.0,0.0,0.0);   //this creates the second line
	glBegin(GL_POLYGON);
	...
	//Letter A
	glColor3f(0.0,1.0,0.0);		//this creates the first line
	glBegin(GL_POLYGON);
	glVertex2f(-0.33,-0.95);
	glVertex2f(-0.13,-0.95);
	glVertex2f(0.15,0.95);
	glVertex2f(0.05,0.95);
	glEnd();

	glColor3f(0.0,1.0,0.0);		//this creates the line in the middle
	glBegin(GL_POLYGON);
	...
	glColor3f(0.0,1.0,0.0);		//this creates the second line
	glBegin(GL_POLYGON);
